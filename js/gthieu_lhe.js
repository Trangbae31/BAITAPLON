...
searchInput.addEventListener('keydown', e => {
  ...
  //form phản hồi
  document.getElementById("form-phan-hoi").addEventListener("submit", function(e) {
  e.preventDefault();
  ...
  // Thông báo đơn giản
  document.getElementById("phanhoi-thongbao").innerText =
    "Cảm ơn bạn " + ten + " đã gửi góp ý!";

  // Hiển thị phản hồi chi tiết
  const hienThi = document.getElementById("phanhoi-hienthi");
  hienThi.innerHTML = `
    <h4>Phản hồi bạn vừa gửi:</h4>
